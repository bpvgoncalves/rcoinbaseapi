...
|        | /v2/accounts/:acc_id/deposits                        | POST   | Deposit Funds        |                      |
|        | /v2/accounts/:acc_id/deposits/:depo_id/commit        | POST   | Commit Deposit       |                      |
|        | /v2/accounts/:acc_id/deposits                        | GET    | List Deposits        |                      |
|        | /v2/accounts/:acc_id/deposits/:depo_id               | GET    | Show Deposit         |                      |
|        | /v2/accounts/:acc_id/withdrawals                     | POST   | Withdraw Funds       |                      |
|        | /v2/accounts/:acc_id/withdrawals/:withd_id/commit    | POST   | Commit Withdrawal    |                      |
|        | /v2/accounts/:acc_id/withdrawals                     | GET    | List Withdrawals     |                      |
|        | /v2/accounts/:acc_id/withdrawals/:withd_id           | GET    | Show Withdrawal      |                      |
|        | /v2/currencies                                       | GET    | Get Fiat Currencies  |                      |
|        | /v2/currencies/crypto                                | GET    | Get Cryptocurrencies |                      |
...
|   ⏳   | /api/v3/brokerage/transaction_summary                | GET    | Get Trans. Summary   |                      |
...
|   ⏳   | /api/v3/brokerage/payment_methods                    | GET    | List Payment Methods |                    |
|   ⏳   | /api/v3/brokerage/payment_methods/{pay_method_id}    | GET    | Get Payment Method   |                    |
