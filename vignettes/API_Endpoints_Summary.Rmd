...
|   ✅   | /v2/accounts/:acc_id/transactions                    | POST   | Send Money           | `transaction_send()` |
...
|   ✅   | /v2/accounts/:acc_id/addresses                       | POST   | Create Address       | `address_new()`      |
|   ✅   | /v2/accounts/:acc_id/addresses                       | GET    | List Addresses       | `address_list()`     |
|   ❌   | /v2/accounts/:acc_id/addresses/:add_id               | GET    | Show Address         |                      |
|   ✅   | /v2/accounts/:acc_id/addresses/:add_id/transactions  | GET    | List Transactions    | `address_transactions_list()` |
